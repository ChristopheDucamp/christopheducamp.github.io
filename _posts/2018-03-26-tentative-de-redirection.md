...
(Extraite de [micro.blog - Help - Custom domains](http://help.micro.blog/2015/custom-domains/ "Permalink to Micro.blog Help - Custom domains")

(...) 
Si vous hébergez votre microblog avec un plan payant de Micro.blog, envisagez de pointer un domaine personnalisé. Cela pourrait être quelque chose ressemblant à  `microblog.votredomaine.com` ou même juste `votredomaine.com`. Mapper un domaine personnalisé vers Micro.blog est inclus gratuitement dans le plan, dès que vous aurez enregistré votre domaine. (Regardez [DNSimple][1] si vous cherchez à enregistrer un nouveau domaine.)
...
Pour action je prévois d'attendre la propagation DNS et [relirai attentivement les instructions](http://help.micro.blog/2015/custom-domains/) demain si ça ne fonctionne pas...
 
[1]: [dnsimple.com/r/9fc1dd2...](https://dnsimple.com/r/9fc1dd2e59824b)
